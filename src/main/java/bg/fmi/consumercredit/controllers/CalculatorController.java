package bg.fmi.consumercredit.controllers;


import bg.fmi.consumercredit.models.Result;
...
public class CalculatorController {
    ...
    public ResponseEntity<Result> calculate(
        ...
        double interestRate = Double.parseDouble(vaultManagerProvider.getProperties().get("bankConsumerCredit").get("interestRate"));
